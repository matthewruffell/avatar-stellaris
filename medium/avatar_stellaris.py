...
configuration = {
    "output_directory" : "/home/matthew/Workspace/COSC460/avatar-stellaris/medium/log/",
    ...
    "machine_configuration": {
            "architecture": "arm",
            "cpu_model": "cortex-m3",
            "entry_address": 0x00000b15,
            "memory_map": [
                {
                    "size": 0x00040000,
                    "name": "flash_firmware",
                    "file": "firmware/Release/Medium.bin",
                    "map":  [{
                            "address": 0x00000000,
                            "type": "code",
                            "permissions": "rwx"
...
cmd.halt()
cmd.raw_cmd("flash write_image erase /home/matthew/Workspace/COSC460/avatar-stellaris/medium/firmware/Release/Medium.bin", True)
cmd.put_bp(0x000006C1) # Run the target until init finishes
...
def device_thread ():
    ...
    cmd.remove_bp (0x000006C1)
    cmd.put_bp (0x00000bea)
    time.sleep (3)
    cmd.raw_cmd ("reset", True)
